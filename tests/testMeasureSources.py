...
class MeasureSourcesTestCase(lsst.utils.tests.TestCase):
    ...
    def testPixelFlags(self):
        ...
        for x, y, setFlags in [(1, 50, ['edge']),
            ...
            spans = afwGeom.SpanSet.spanSetFromShape(5).shiftedBy(x + x0,
                                                                  y + y0)
        ...
        tmpSpanSet = afwGeom.SpanSet.spanSetFromShape(5).shiftedBy(x + x0,
                                                                   y + y0)
        ...
        tmpSpanSet2 = afwGeom.SpanSet.spanSetFromShape(5).shiftedBy(x + x0,
                                                                    y + y0)
