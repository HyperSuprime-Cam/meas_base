...
class UndeblendedTestCase(lsst.utils.tests.TestCase):
    def testUndeblendedMeasurement(self):
        ...
        spanSetParent = afwGeom.SpanSet.spanSetFromShape(int(radius))
        ...
        spanSetChild1 = afwGeom.SpanSet.spanSetFromShape(1)
        ...
        spanSetChild2 = afwGeom.SpanSet.spanSetFromShape(1)
